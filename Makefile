all: test_main.o sdl.o main_display.o basedraw.o dot_font.o hzk16
	gcc -o out/main out/test_main.o out/sdl.o out/main_display.o out/basedraw.o out/dot_font.o -lSDL -I/usr/include/SDL/
...
basedraw.o: libs/lib_graphics/lib_base_draw/basedraw.c
	gcc -c -o out/basedraw.o libs/lib_graphics/lib_base_draw/basedraw.c -I./libs/lib_graphics/lib_base_draw -I./linux_base
